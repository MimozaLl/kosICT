...
public class Speakers extends Activity
{
	...
	{
			mySpeakers.add(new Speaker(R.drawable.anders_indset,"Anders Indset"," ","facebook.com/anders.indset" ,new String(getString(R.string.AndersIndset))));
			mySpeakers.add(new Speaker(R.drawable.jimmy_leach,"Jimmy Leach","","twitter.com/JimmyTLeach" ,new String(getString(R.string.JimmyLeach))));
			mySpeakers.add(new Speaker(R.drawable.arild_larsen,"Arild Bjørn-Larsen","","" ,new String(getString(R.string.AridLarsen))));
			mySpeakers.add(new Speaker(R.drawable.jovanka_guliscoska,"Bernhard Janischowsky","","" ,new String(getString(R.string.BernardJanischowsky))));
